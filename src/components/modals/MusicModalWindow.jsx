    ...
    return (
        ...
        >
            <div ref={nodeRef} className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-end">
                <div className="bg-[#504e4a] w-full h-[580px] fixed rounded-t-2xl flex justify-center">
                    <button className="h-10 w-10 absolute left-1 ml-4 mt-5" onCl
                        ick={closeWindow}>
                    ...
                    <div className="">
                        <img className='mt-[60px] rounded-sm h-[268px] w-[268px]' src={props.img} alt="Картина песни" />
