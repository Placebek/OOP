        ...
        >
            <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-end">
                <div className="bg-[#504e4a] w-full h-[580px] rounded-t-2xl relative flex justify-center">
                    ...
                    <div className="mt-8">
                        <img className='rounded-sm h-[268px] w-[268px]' src={props.post.img} alt="Картина песни" />
                        <p className="text-center mt-4 text-3xl text-white">{props.post.title}</p>
                        <p className="text-center mt-1 text-sm font-extralight text-white">{props.post.authorName}</p>
                    </div>
