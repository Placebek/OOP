                ...
                <div className="bg-white h-[75px]">
                    <ul className="flex flex-row gap-24">
                        <li className="ml-[48px] mt-4">
                            <button onClick={() => changeActive('home')} className={`h-[40px] w-[40px] ${activeMenu === 'home' ? 'custom-shadow' : 'shadow-none'}`}>
                        ...
                        <li className="mt-4">
                            <button onClick={() => changeActive('fire')} className={`${activeMenu === 'fire' ? 'custom-fire-shadow' : 'shadow-none'}`}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill={checkLike} className="bi bi-fire" viewBox="0 0 16 16">
